...
$filter_query = "select * from B_ANCHOR_DETAILS where";

$filter_query = $filter_query . "(price between " . $min_price . " and " .  $max_price . " ) and";

$filter_query = $filter_query . "(anchor_performing_team between " . $min_members . " and " .  $max_members . ")";
      ...
      <div class="col-sm-9 anchor-main-container">
       <div class="row anchor-new-row">
        <?php
          ...
          $retval = mysql_query( $filter_query, $conn );
        ...
        ?>
          ...
          <div class="col-sm-6 anchor-container">
            ...
            <div>
              <h3><?php echo "{$row['anchor_name']}"; ?><div class="status right online"></div>
              </h3>
               <?php
